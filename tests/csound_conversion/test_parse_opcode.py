...
from cordelia.csound_conversion.opcode import parse

def test_simple_opcode():
	code = r"""
/*
...
"""
	opcode = parse(code)
	assert opcode.name == 'cordelia_radio'
	assert opcode.ins == 'ak'
	assert opcode.outs == 'a'

def test_real_exemple():
	code = r"""
/*
hello, i'm in duerne and i'd love to have some traitements
that can give you a radio sensation, not clearly straightforward, but
...
#define cordelia_radio_high_freq_jit#jitter(1500, 1/32, 1/8)#
	...
	opcode Error_cordelia_forerver, a, ak
	ain, kwet xin
